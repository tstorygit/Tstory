...
// Linked cost: starts at 10000 coins + 25 gems, doubles per total weapons purchased
export function calcUltWeaponCost(totalPurchased) {
    return {
        coins: Math.floor(10000 * Math.pow(2, totalPurchased)),
        gems:  Math.floor(25   * Math.pow(2, totalPurchased))
    };
}
// ─────────────────────────────────────────────────────────────────────────────
