...
function _generateDeck(validWords) {
    // 1. Shuffle and slice required pairs
...
function _spawnFloatingText(x, y, text) {
    ...
    document.body.appendChild(fx); // Append to body so it escapes hidden overflow
